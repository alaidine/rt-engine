...
public:
  ...
  /* Set the Vulkan objects required for swapchain creation and management, must
   * be called before swapchain creation */
  void setContext(VkInstance instance, VkPhysicalDevice physicalDevice,
                  VkDevice device);
  /**
   ...
   * @param vsync (Optional, default = false) Can be used to force vsync-ed
   * rendering (by using VK_PRESENT_MODE_FIFO_KHR as presentation mode)
   */
